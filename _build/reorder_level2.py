...
ORDER = [
    ...
    ("chapter-level-2-music-theory-the-minor-triad.html",
     ...
     "Music Theory: The Minor Triad"),
    ("chapter-level-2-the-fretboard-minor-triad-shapes-on-the-e-a-d-and-a-d-g-string-sets.html",
     "The Fretboard: Minor Triad Shapes on the E-A-D and A-D-G String Sets",
     "The Fretboard: Minor Triad Shapes on the E-A-D and A-D-G String Sets"),
    ("chapter-level-2-the-fretboard-common-major-triad-voicings.html",
